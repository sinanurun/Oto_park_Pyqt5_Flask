...
# Form implementation generated from reading ui file 'abone_guncelle_sil.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Temel Abone İşlemlerine Hoş Geldiniz"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Adı Soyadı"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Telefonı"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Katsayısı"))
