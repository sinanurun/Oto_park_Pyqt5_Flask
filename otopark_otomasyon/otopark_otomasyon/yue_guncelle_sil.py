...
# Form implementation generated from reading ui file 'uye_guncelle_sil.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Temel Üyelik İşlemlerine Hoş Geldiniz"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Adı Soyadı"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "T.C. No"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Sifre"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Telefon"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Adres"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Form", "Üye Notu"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Eğitmen"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "Üyelik Bitiş Tarihi"))
